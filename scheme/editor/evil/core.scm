...
(set-key! normal-map "ctrl-r" 'evil-redo)
...
(set-key! normal-map "ctrl-v" 'evil-select-rectangle)
(set-key! normal-map "g g" 'evil-motion-gg)
(set-key! normal-map "G" 'evil-motion-G)
(set-key! normal-map "ctrl-o" 'evil-jump-backward)
(set-key! normal-map "ctrl-i" 'evil-jump-forward)
...
(set-key! insert-map "alt-h"    'evil-motion-h)
(set-key! insert-map "alt-j"    'evil-motion-j)
(set-key! insert-map "alt-k"    'evil-motion-k)
(set-key! insert-map "alt-l"    'evil-motion-l)
...
(set-key! insert-map "ctrl-v"   'evil-insert-paste-clipboard)

;; Select (visual) mode bindings
(set-key! select-map "v" 'evil-select)
(set-key! select-map "V" 'evil-select-line)
(set-key! select-map "ctrl-v" 'evil-select-rectangle)
