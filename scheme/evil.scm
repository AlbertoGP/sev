...
(set-key! evil-normal-map "M-0" 'reset-global-scale)
(set-key! evil-normal-map "M-=" 'increase-global-scale)
(set-key! evil-normal-map "M--" 'decrease-global-scale)
(set-key! evil-normal-map "C-0" 'reset-buffer-scale)
(set-key! evil-normal-map "C-=" 'increase-buffer-scale)
(set-key! evil-normal-map "C--" 'decrease-buffer-scale)
