...
(set-key! normal-map "LEFT" 'evil-motion-h)
(set-key! normal-map "DOWN" 'evil-motion-j)
(set-key! normal-map "UP" 'evil-motion-k)
(set-key! normal-map "RIGHT" 'evil-motion-l)
...
(set-key! insert-map "LEFT" 'evil-motion-h)
(set-key! insert-map "DOWN" 'evil-motion-j)
(set-key! insert-map "UP" 'evil-motion-k)
(set-key! insert-map "RIGHT" 'evil-motion-l)
...
(set-key! select-map "h" 'evil-motion-h)
(set-key! select-map "j" 'evil-motion-j)
(set-key! select-map "k" 'evil-motion-k)
(set-key! select-map "l" 'evil-motion-l)
(set-key! select-map "LEFT" 'evil-motion-h)
(set-key! select-map "DOWN" 'evil-motion-j)
(set-key! select-map "UP" 'evil-motion-k)
(set-key! select-map "RIGHT" 'evil-motion-l)
...
(set-key! pending-map "LEFT" 'evil-motion-h)
(set-key! pending-map "DOWN" 'evil-motion-j)
(set-key! pending-map "UP" 'evil-motion-k)
(set-key! pending-map "RIGHT" 'evil-motion-l)
